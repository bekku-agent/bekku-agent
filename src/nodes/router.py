...
async def route(state: AgentState) -> AgentState:
    """Classify the task into one of three types using gpt-4o-mini."""
        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "- content: writing blog posts, tutorials, guides, technical articles\n"
                    "- interactive: live questions, conversations, quick answers, explanations\n"
                    "- feedback: product feedback, API critiques, feature requests, improvement suggestions for RevenueCat\n\n"
